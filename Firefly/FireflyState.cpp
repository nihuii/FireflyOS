...
lv_obj_t * settings_alarm_status_label = NULL;
lv_obj_t * settings_alarm_time_label = NULL;
lv_obj_t * settings_alarm_switch = NULL;
lv_obj_t * settings_brightness_slider = NULL;
lv_obj_t * settings_brightness_value_label = NULL;
lv_obj_t * settings_sleep_roller = NULL;
lv_obj_t * roller_alarm_hour = NULL;
lv_obj_t * roller_alarm_minute = NULL;
